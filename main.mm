...
- (instancetype)init {
    ...
    if (self) {
        // جعل النافذة تظهر فوق كل شيء طوال الوقت على شاشة الآيفون
...
// تصميم وتثبيت الزر العائم وقابليته للتحريك بالسحب
- (void)createFloatingButton {
    ...
    // ميزة تحريك وسحب الزر بالإصبع طوال الوقت
...
// تصميم قائمة التحكم والخصائص (المميزات المطلوبة)
- (void)createMenuView {
...
- (void)clearTargetsClick {
    for (UIView *view in self.targetCircles) {
